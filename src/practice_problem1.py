...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.init_contents = self.contents
        self.history = []
    ...
    def append_string(self, additional_contents):
        ...
        for k in range(len(additional_contents)):
            if k < space:
                ...
                leftover += additional_contents[k]
        return(leftover)
    ...
    def steal(self, other_box):
        ...
        space = self.volume - len(self.contents)
        leftover = ''
        for k in range(len(other_box.contents)):
            if len(self.contents) < self.volume:
                self.contents += other_box.contents[k]
            else:
                leftover += other_box.contents[k]
